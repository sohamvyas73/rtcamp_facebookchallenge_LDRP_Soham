...
if (isset($_POST['zip_button'])) {
  ...
  header("location:http://localhost/RTcamp/zip_download.php");
...
if(isset($_POST['zip_custom'])){
  ...
  if(isset($_POST['photos_check']) and count($_POST['photos_check']) > 0)  
     { 
        ...
        header("location:http://localhost/RTcamp/zip_custom.php");
  
  }

}
if (isset($_POST['move_button'])) {
  header("location:http://localhost/RTcamp/move_all.php");
...
if(isset($_POST['move_custom'])){
  ...
  if(isset($_POST['photos_checkg']) and count($_POST['photos_checkg']) > 0)  
     { 
        ...
        header("location:http://localhost/RTcamp/move_custom.php");
...
<a class='Button' href='#popup2' style='float: right;'><span class='Button__textWrapper'><span class='Button__text'>Google Backup</span><span class='Button__icon' aria-hidden='true'></span></span></a>
    ...
    <div id='image-gallery'>
      <div class='row'>";
          ...
          <div class='img-wrapper'><a href='{$al[$i]['source']}'><img src='{$al[$i]['source']}' class='img-responsive' /></a><div class='img-overlay'>
    ...
    <div id='image-gallery'>
      ...
      //print_r($responseI);
        ...
        <div class='column image'>
          ...
          <div class='down'>
            <input type='submit' value='Download'> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='submit' value='Backup'>
            </div>
        </div>
